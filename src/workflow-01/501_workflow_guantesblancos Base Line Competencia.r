...
#  param_local$final_train <- c(202105, 202104, 202103, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001SEM", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001SEM", "DT0001SEM" )

  DR_drifting_guantesblancos( "DR0001SEM", "CA0001SEM" )
  FE_historia_guantesblancos( "FE0001SEM", "DR0001SEM" )

  TS_strategy_guantesblancos_202109( "TS0001SEM", "FE0001SEM" )

  HT_tuning_guantesblancos( "HT0001SEM", "TS0001SEM" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001SEM", c("HT0001SEM","TS0001SEM") )
...
#{
  ...
  #TS_strategy_guantesblancos_202107( "TS0002BLF", "FE0001BLF" )

  #HT_tuning_guantesblancos( "HT0002BLF", "TS0002BLF" )

  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0002BLF", c("HT0002BLF", "TS0002BLF") )
...
corrida_guantesblancos_202109( "gb01SEM" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "gb02BLF" )
