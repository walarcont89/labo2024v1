...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_B4", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_B4", "DT0001_B4" )

  DR_drifting_guantesblancos( "DR0001_B4", "CA0001_B4" )
  FE_historia_guantesblancos( "FE0001_B4", "DR0001_B4" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_B4", "FE0001_B4" )

  HT_tuning_guantesblancos( "HT0002_B4", "TS0002_B4" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_B4", c("HT0002_B4", "TS0002_B4") )
...
corrida_guantesblancos_202109( "gb01_B4" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_B4" )
