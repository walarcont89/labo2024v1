...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
  
  #param_local$train$training <- c(202105, 202104, 202103)
  #param_local$train$validation <- c(202106)
  #param_local$train$testing <- c(202107)

  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107)
...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$future <- c(202107)
  param_local$final_train <- c(202105, 202104, 202103, 202102, 202101, 202012, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)


  param_local$train$training <- c(202103, 202102, 202101, 202012, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
  param_local$train$validation <- c(202104)
  param_local$train$testing <- c(202105)  
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_B3", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_B3", "DT0001_B3" )

  DR_drifting_guantesblancos( "DR0001_B3", "CA0001_B3" )
  FE_historia_guantesblancos( "FE0001_B3", "DR0001_B3" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_B3", "FE0001_B3" )

  HT_tuning_guantesblancos( "HT0002_B3", "TS0002_B3" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_B3", c("HT0002_B3", "TS0002_B3") )
...
corrida_guantesblancos_202109( "gb01_B3" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_B3" )
