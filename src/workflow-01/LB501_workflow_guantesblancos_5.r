...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202005, 202002, 202001, 201912, 201911, 201910, 201909)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_B5", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_B5", "DT0001_B5" )

  DR_drifting_guantesblancos( "DR0001_B5", "CA0001_B5" )
  FE_historia_guantesblancos( "FE0001_B5", "DR0001_B5" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_B5", "FE0001_B5" )

  HT_tuning_guantesblancos( "HT0002_B5", "TS0002_B5" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_B5", c("HT0002_B5", "TS0002_B5") )
...
corrida_guantesblancos_202109( "gb01_B5" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_B5" )
