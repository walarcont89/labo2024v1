...
PARAM$finalmodel$num_iterations <- 279
PARAM$finalmodel$learning_rate <- 0.0568159688962331
PARAM$finalmodel$feature_fraction <- 0.986976566746033
PARAM$finalmodel$min_data_in_leaf <- 1475
PARAM$finalmodel$num_leaves <- 260
