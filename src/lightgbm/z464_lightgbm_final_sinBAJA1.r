...
PARAM$finalmodel$num_iterations <- 869
PARAM$finalmodel$learning_rate <- 0.0101613653462483
PARAM$finalmodel$feature_fraction <- 0.781783575208124
PARAM$finalmodel$min_data_in_leaf <- 1606
