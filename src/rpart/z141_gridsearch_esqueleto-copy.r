...
PARAM$semillas <- c(299909, 299977, 300007, 300007, 300089)
...
for (vcp in c(-1, -0.8,-0.3, 0.3, 0.8, 1)) {
  for (vmax_depth in c(2,8,12,18,24,30)){
    for (vmin_split in c(35,180, 340, 660, 930, 1240)) {
      for (vmin_bucket in c(2, 18, 24, 400 )) {
